...
describe('transitionMetricsDemandState', () => {
  it('allows one request or retry and ignores stale outcomes', () => {
  ...
  it('abandons only the request that still owns the demand update', () => {
  ...
  it('does not let a stale request schedule a retry', () => {
