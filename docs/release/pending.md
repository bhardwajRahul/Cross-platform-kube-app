...
- **Auto-updates.** The app now checks for new releases and lets you perform an in-place upgrade. Rollout of this feature begins with macOS. Unsupported installation types continue to offer the manual download path.
